...
def draw(canvas):
    ...
    # collisions for missiles and rock and score
...
def rock_spawner():
    ...
    d = dist(a_rock.get_position(), my_ship.get_position())
    min_dist = a_rock.get_radius() + my_ship.get_radius() + 40
    
    # rock_spawner requirements
